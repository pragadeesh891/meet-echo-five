...
var config = {
    // ECHO-FIVE-MEET Custom Configuration
    // Connection
    //

    hosts: {
        // XMPP domain.
        domain: 'meet.echo-five.com',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'meet.echo-five.com',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.meet.echo-five.com',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'meet.echo-five.com',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://meet.echo-five.com/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://meet.echo-five.com/' + subdir + 'xmpp-websocket',
    ...
    // websocketKeepAliveUrl: 'https://meet.echo-five.com/' + subdir + '_unlock',
    ...
    // focusUserJid: 'focus@auth.meet.echo-five.com',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="meet.echo-five.com" -->/' + subdir + 'conference-request/v1',
