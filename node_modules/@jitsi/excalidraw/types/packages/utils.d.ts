...
export declare function splitArrayByByteSize(arr: readonly ExcalidrawElement[], maxSizeInBytes: number): (import("../types").ExcalidrawLinearElement | import("../types").ExcalidrawSelectionElement | import("../types").ExcalidrawRectangleElement | import("../types").ExcalidrawDiamondElement | import("../types").ExcalidrawEllipseElement | import("../types").ExcalidrawImageElement | import("../types").ExcalidrawTextElement | import("../types").ExcalidrawFreeDrawElement)[][];
